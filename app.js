...
function ProjectApp({
  ...
  const renderModulosView = () => {
    ...
    return React.createElement("div", {
      ...
      }, showHours ? "▲" : "▼", " ", isEclient || isAdmin ? "Cargar horas" : "")), showHours && React.createElement("div", {
        style: {
          marginTop: 8
        }
      ...
      }, h.hours, "h"), React.createElement("span", {
        style: {
          color: D.textMuted
        }
      }, fmtD(h.date)))), hardData.hoursLog.length > 5 && React.createElement("div", {
        style: {
          fontSize: 9,
          color: D.textMuted
        }
