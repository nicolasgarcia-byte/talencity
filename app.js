...
function ProjectApp({
  ...
  const renderModulosView = () => {
    ...
    return React.createElement("div", {
    ...
    }, "cargando...")), severaCache && (severaCache.phases || []).map(ph => {
      ...
      }, fmtD(ph.deadline))), ph.status && React.createElement("span", {
        style: {
          fontFamily: "'Press Start 2P',monospace",
          fontSize: 6,
          color: "#7dc9b2",
      ...
      }, ph.status)), React.createElement("div", {
        style: {
          marginBottom: 8
        }
      }, React.createElement("div", {
      ...
      }, "⏱ Horas cargadas: ", React.createElement("span", {
        style: {
          color: "#7dc9b2",
          fontWeight: 600
        }
      }, totalHrs, "h")), (isEclient || isAdmin) && React.createElement("div", {
        style: {
          display: "flex",
          gap: 6,
          alignItems: "center",
      ...
      }, "+ CARGAR")), hardData.hoursLog.length > 0 && React.createElement("div", {
        style: {
          marginTop: 6
        }
      }, hardData.hoursLog.slice(-3).map(h => React.createElement("div", {
        key: h.id,
        style: {
          display: "flex",
          gap: 6,
      ...
      }, React.createElement("span", null, h.authorEmoji), React.createElement("span", null, h.authorName), React.createElement("span", {
        style: {
          color: "#7dc9b2"
        }
      }, h.hours, "h"), React.createElement("span", null, fmtD(h.date)))), hardData.hoursLog.length > 3 && React.createElement("div", {
        style: {
          fontSize: 9,
          color: D.textMuted
        }
      }, "...y ", hardData.hoursLog.length - 3, " más"))), React.createElement("div", null, React.createElement("div", {
        style: {
          fontSize: 10,
          color: D.textSub,
          marginBottom: 3
