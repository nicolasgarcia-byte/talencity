...
function TalentCity() {
  ...
  const Dashboard = () => {
    ...
    return React.createElement("div", {
      ...
      }, React.createElement("thead", null, React.createElement("tr", null, ["PROYECTO", "TIPO", "FECHA INICIO", "FECHA FIN", "MÓDULOS", "MOD. COMPL.", "TAREAS", "REALIZADAS", "VENCIDAS", "HS ADMIN", "HS CLIENTE", "AVANCE"].map(h2 => React.createElement("th", {
        key: h2,
        style: th
